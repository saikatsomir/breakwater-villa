    ...
    return (
      <main className="min-h-screen bg-[#f7f5f0] flex items-center justify-center px-6">
        <div className="w-full max-w-xl rounded-2xl bg-white p-8 md:p-12 text-center shadow-sm">
          ...
          <p className="mt-4 text-neutral-600 leading-7">{error}</p>
        </div>
      </main>
    );
  }
            ...
            {success ? (
              <>
                ...
                <p className="mx-auto mt-4 max-w-lg leading-7 text-neutral-600">
                  This reservation has been successfully confirmed. The selected
                  dates are now blocked from future reservations.
                </p>
              </>
            ) : (
              <>
                ...
                <p className="mx-auto mt-4 max-w-lg leading-7 text-neutral-600">
                  Please review the reservation details below before confirming
                  this booking.
                </p>
              </>
            )}
